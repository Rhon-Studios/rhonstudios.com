...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    const staticRoutes: MetadataRoute.Sitemap = [
        ...
        { url: `${SITE_URL}/games/afterlight`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
        { url: `${SITE_URL}/games/tinycare`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
        { url: `${SITE_URL}/games/theobserver`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
        { url: `${SITE_URL}/games/tonkori`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    ];
