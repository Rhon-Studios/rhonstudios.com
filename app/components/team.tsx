...
import { team, collaborators } from "@/app/DataBases/teamData";
                    ...
                    <div className="border-t-2 border-white/20 pt-10 sm:pt-12">
                        ...
                        <div className="hidden lg:flex flex-row flex-wrap justify-center gap-20 group">
                            {team.map((member, index) => {
                                const tMember = t.ourteam.main_team[member.id];
                                return (
                                    <div
                                        key={member.id}
                                    ...
                                    >
                                        <div
                                            className="aspect-square bg-white/5 border-2 border-white/20 mb-6 relative overflow-hidden group-hover:border-white/40 transition-all duration-300">
                                            {member.img ? (
                                                <img
                                                    src={member.img}
                                                    alt={member.name}
                                            ...
                                            <div
                                                className="absolute top-4 left-4 w-8 h-8 border-t-2 border-l-2 border-white/30 group-hover:border-white/50"></div>
                                            <div
                                                className="absolute bottom-4 right-4 w-8 h-8 border-b-2 border-r-2 border-white/30 group-hover:border-white/50"></div>
                                        </div>
                                        <h4 className="text-2xl mb-2 tracking-wide"
                                            style={{fontFamily: "Cinzel", fontWeight: "bold"}}>
                                            {member.name}
                                        </h4>
                                        <p className="text-sm tracking-wider text-white/60 mb-2"
                                           style={{fontFamily: "Cinzel", fontWeight: 200, fontSize: "13px"}}>
                                            {member.role}
                                        </p>
                                        <p className="text-sm leading-relaxed tracking-wide text-white/80 mb-2 flex-grow"
                                        ...
                                        <div
                                            ...
                                            `}
                                        >
                                            <p className="text-sm leading-relaxed tracking-wide text-white/80 mb-6 flex-grow"
                                        ...
                                        <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isExpanded ? "max-h-96 mt-4" : "max-h-0"}`}>
                                            <div className="border-t border-white/20 pt-4">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    <a href={member.github} className="text-white/60 hover:text-white transition-colors duration-300" aria-label="GitHub">
                                                        <Github className="w-4 h-4" />
                                                    </a>
                                                    <a href={member.linkedin} className="text-white/60 hover:text-white transition-colors duration-300" aria-label="LinkedIn">
                                                        <Linkedin className="w-4 h-4" />
                                                    </a>
                                                    <a href={`mailto:${member.email}`} className="text-white/60 hover:text-white transition-colors duration-300" aria-label="Email">
                                                        <Mail className="w-4 h-4" />
                                                    </a>
                                                    <a href={member.twitter} className="text-white/60 hover:text-white transition-colors duration-300" aria-label="Twitter">
                        ...
                        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
                            {collaborators.map((c, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className="w-10 h-10 border border-white/20 flex items-center justify-center mb-4">
