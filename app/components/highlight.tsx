...
export function Highlight() {
    ...
    return (
        ...
        >
            ...
            <h1
                className="relative text-center pointer-events-none px-4 text-4xl sm:text-6xl md:text-7xl lg:text-8xl"
            ...
            <svg
                width="193" height="200" viewBox="0 0 193 200"
                fill="none" xmlns="http://www.w3.org/2000/svg"
                className="absolute top-4 left-4 sm:top-8 sm:left-8 w-10 h-10 sm:w-16 sm:h-16"
            >
                <motion.path
            ...
            <svg
                width="193" height="200" viewBox="0 0 193 200"
                fill="none" xmlns="http://www.w3.org/2000/svg"
                className="absolute bottom-4 right-4 sm:bottom-8 sm:right-8 w-10 h-10 sm:w-16 sm:h-16"
            >
                <motion.path
                    initial={{ pathLength: 0 }}
                    whileInView={{ pathLength: 1 }}
            ...
            <div className="absolute top-4 sm:top-8 left-1/2 -translate-x-1/2 mt-4 sm:mt-10">
                <div className="inline-block border-2 border-white/80 px-4 sm:px-10 py-1 sm:py-2 rounded-md bg-black/60 backdrop-blur-sm">
                    <p
                        className="text-[8px] sm:text-xs tracking-[0.3em] uppercase text-white text-center"
