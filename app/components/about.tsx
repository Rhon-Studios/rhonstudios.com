...
export function About() {
    ...
    return (
        <section 
            id="about" 
            className="snap-center scroll-mt-[5px] relative bg-black text-white pt-32 overflow-hidden"
            style={{ 
                minHeight: '20vh',
            }}
        >
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-16 mt-7">
                        <div>
                            ...
                            <p
                                className="text-lg leading-relaxed tracking-wide text-white/80"
                                style={{ fontFamily: "Cinzel" }}
                            >
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-15 mb-12">
                        <div className="group border-2 border-white/30 p-8 hover:border-white/60 transition-all duration-300 text-center">
                            <h4
                            ...
                            <p
                                className="text-sm tracking-wide opacity-70 group-hover:opacity-100 transition-all duration-300"
                                style={{ fontFamily: "Cinzel" }}
                            >
