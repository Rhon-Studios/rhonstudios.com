    ...
    <div className="bg-black text-white min-h-screen pt-30">
      <section className="relative pt-48 pb-24 px-8 lg:px-16 border-b border-white/10">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            No construimos en silencio. Aquí contamos todo: las decisiones que tomamos, los
            problemas que encontramos y el porqué detrás de cada elección.
          </motion.p>
        </div>
    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-1 text-white/30">
          ...
          <span className="text-xs" style={{ fontFamily: "Cinzel" }}>
