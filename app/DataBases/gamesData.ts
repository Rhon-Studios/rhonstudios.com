...
export const gamesData: GameData[] = [
    ...
    },
    {
        ...
        theme: {
            ...
            progressFrom: "from-[#1a4a42]",
            progressTo: "to-[#2d7a68]",
            progressTrackBg: "bg-[#0d1f1c]",
            colorCompleted: "text-[#4ade80]",
            colorInProgress: "text-[#60a5fa]",
            colorToDecide: "text-[#94a3b8]",
            ...
            investmentHighlightBorder: "border-[#1e4a42]",
            investmentHighlightBg: "bg-[rgba(20,50,44,0.4)]",
    ...
    },
    {
        ...
        theme: {
            ...
            progressFrom: "from-[#d4a373]",
            progressTo: "to-[#ccd5ae]",
            progressTrackBg: "bg-[#2a2621]",
            colorCompleted: "text-[#ccd5ae]",
            colorInProgress: "text-[#d4a373]",
            colorToDecide: "text-[#8f8b82]",
            heroOverlay: "from-[rgba(17,16,17,.15)] via-[rgba(17,16,17,.72)] to-[rgba(17,16,17,1)]",
            heroFilter: "brightness(.82) saturate(.9)",
            investmentHighlightBorder: "border-[#d4a373]",
            investmentHighlightBg: "bg-[#d4a373]/10",
