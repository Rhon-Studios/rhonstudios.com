    ...
    <div className="max-w-5xl mx-auto">
      <div className="text-center mb-12 sm:mb-20">
        <h2
          ...
          style={{ fontFamily: fontTitle, color: fontTitleColor }}
        >
          {title}
        </h2>
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
      {items.map((item, i) => (
        <div
          key={i}
          className="border-2 p-5 sm:p-8 transition-all duration-300 relative group"
          style={{ borderColor }}
        >
          <div className={cornerClass} style={{ borderColor }} />
          <h4
            className="text-sm sm:text-lg mb-2 tracking-wide"
            style={{ fontFamily: fontBody, fontWeight: "bold", color: textSubtleColor }}
          >
            {item.title}
          </h4>
          <p
            className="text-xs sm:text-base leading-relaxed"
            style={{ fontFamily: fontBody, color: textMutedColor }}
          >
            {item.description}
          </p>
        </div>
...
export function GamePageClient({ id }: { id: string }) {
  ...
  const renderStatusIcon = (status: string) => {
    switch (status) {
      case "completed":
        return (
          <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: theme.colorCompleted }} />
        );
      case "in-progress":
        return <Clock className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: theme.colorInProgress }} />;
      case "planned":
        return <Circle className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: theme.textMuted }} />;
      case "to-decide":
        return (
          <CircleQuestionMark
            className="w-4 h-4 sm:w-5 sm:h-5"
            style={{ color: theme.colorToDecide }}
          />
        );
      default:
        return <Circle className="w-4 h-4 sm:w-5 sm:h-5" style={{ color: theme.accentText }} />;
    }
  };
      ...
      >
        ...
        <div className="relative z-10 text-center">
          <h1
            ...
            style={{ fontFamily: defaultTheme.fontTitle, color: defaultTheme.fontTitleColor }}
          >
    ...
    <div className="min-h-screen" style={{ backgroundColor: theme.bgColor }}>
      ...
      >
        ...
        <div className="relative z-10 w-full mx-auto px-6 sm:px-8 lg:px-16 text-center">
          ...
          <p
            className="text-lg sm:text-2xl lg:text-3xl mb-6 sm:mb-8 tracking-wide"
            style={{ color: theme.textMuted, fontFamily: theme.fontBody, fontWeight: 200 }}
          >
            {gameT.subtitle}
          </p>
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 justify-center">
            ...
            {game.links.demo && (
              <ThemedLink href={game.links.demo} theme={theme}>
                <Play className="w-3.5 h-3.5 sm:w-4 sm:h-4" style={{ color: theme.accentText }} />
                <span
                  className="tracking-wider text-xs sm:text-sm"
                  style={{ color: theme.fontBodyColor, fontFamily: theme.fontBody }}
                >
            ...
            {game.links.github && (
              <ThemedLink href={game.links.github} theme={theme}>
                <Github className="w-3.5 h-3.5 sm:w-4 sm:h-4" style={{ color: theme.accentText }} />
                <span
                  className="tracking-wider text-xs sm:text-sm"
                  style={{ color: theme.fontBodyColor, fontFamily: theme.fontBody }}
                >
        ...
        {[
          ...
          <div
            key={i}
            className={`absolute ${cls} w-10 sm:w-16 h-10 sm:h-16`}
            style={{ borderColor: theme.accentBorder }}
          />
        ))}
      </section>
          ...
          <div className="border-2" style={{ borderColor: theme.panelBorderOpacity }}>
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
                ...
                >
                  <h4
                    className="text-lg sm:text-2xl mb-2 tracking-wide"
                    style={{
                      fontFamily: theme.fontBody,
                      fontWeight: "bold",
                      color: theme.textSubtle,
                  ...
                  <div className="space-y-4 sm:space-y-7">
                    ...
                    >
                      <motion.div
                        ...
                        style={{
                          backgroundImage: `linear-gradient(to right, ${theme.progressFrom}, ${theme.progressTo})`,
                        }}
                      />
                    </div>
                    <p
            ...
            >
              <div className="space-y-4 sm:space-y-8">
                {gameT.roadmap.map(
                  (phase: { phase: string; status: string; items: string[] }, i: number) => (
                    <div
                      key={i}
                      className="border-2 p-5 sm:p-8"
                    ...
                    >
                      <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6 flex-wrap">
                        ...
                        <h3
                          className="text-base sm:text-2xl tracking-wider flex-1"
        ...
        <div className="container mx-auto px-4 sm:px-8 lg:px-16">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="space-y-4 sm:space-y-8 mb-8 sm:mb-12">
              {[
                {
                  label: t.gamePage.investment.monetization,
                  content: gameT.investment.monetization,
                },
                ...
                >
                  <h3
                    className="text-lg sm:text-2xl mb-3 sm:mb-4 tracking-wider"
                    style={{ fontFamily: theme.fontBody, color: theme.textSubtle }}
                  >
                    {label}
                  </h3>
                  <p
                    className="text-xs sm:text-base tracking-wide leading-relaxed"
                    style={{ fontFamily: theme.fontBody, color: theme.textMuted }}
                  >
                    {content}
                  </p>
            ...
            <div
              className="border-2 p-5 sm:p-8"
              style={{
                borderColor: theme.investmentHighlightBorder,
                backgroundColor: theme.investmentHighlightBg,
              }}
            >
              <h3
                className="text-lg sm:text-2xl mb-4 sm:mb-6 tracking-wider"
                style={{ fontFamily: theme.fontBody, color: theme.textSubtle }}
              >
      ...
      <section
        id="contact"
        className="py-16 sm:py-24 border-t-2"
        style={{ backgroundColor: theme.bgColor, borderColor: theme.panelBorderOpacity }}
      >
        <div className="container mx-auto px-4 sm:px-8 lg:px-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              className="text-sm sm:text-xl mb-8 sm:mb-12 tracking-wide"
              style={{ fontFamily: theme.fontBody, color: theme.textMuted }}
            >
