...
export function GameGallery({ images, gameTitle, theme }: GameGalleryProps) {
  ...
  const categories: Array<"all" | GalleryImage["category"]> = [
    "all",
    ...
    >
            ...
            {filteredImages.map((image, index) => {
              ...
              return (
                ...
                >
                  ...
                  {}
                  <CollaboratorCredit
                    collaboratorId={image.collaboratorId}
                    theme={theme}
                    variant="card"
                  />
      ...
      {selectedImages && (
        ...
        >
          ...
          >
            <div
              className="relative border-2 overflow-hidden bg-black"
              style={{ borderColor: theme.panelBorderOpacity }}
            >
              ...
              />
              <div
                className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 w-8 h-8 sm:w-12 sm:h-12 border-b-2 border-r-2"
                style={{ borderColor: theme.textSubtle }}
              />
            </div>
            <div className="mt-3 sm:mt-6 text-center">
              <div
                className="inline-block border px-3 sm:px-4 py-1 mb-2 sm:mb-4"
                style={{ borderColor: theme.panelBorderOpacity }}
              >
                <span
                  className="text-[9px] sm:text-xs tracking-wider uppercase"
              ...
              <div className="flex justify-center">
                <CollaboratorCredit
                  collaboratorId={selectedImages.collaboratorId}
                  theme={theme}
                  variant="modal"
                />
              </div>
