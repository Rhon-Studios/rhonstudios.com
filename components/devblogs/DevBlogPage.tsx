      ...
      <article className="relative pt-32 sm:pt-48 pb-24 sm:pb-32 px-6 sm:px-8 lg:px-16">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            <span
              className="text-xs tracking-[0.2em] uppercase border-2 border-white/30 px-3 py-1 text-white/55"
              style={{ fontFamily: "Cinzel" }}
            >
              {post.project}
            </span>
          ...
          <h1
            className="text-3xl sm:text-5xl tracking-wider mb-6 sm:mb-8 leading-tight"
          ...
          <div
            className="text-base sm:text-lg text-white/60 leading-relaxed mb-10 sm:mb-12 border-l-2 border-white/20 pl-5 sm:pl-6"
            style={{ fontFamily: "Cinzel", fontWeight: 200 }}
          >
            <ReactMarkdown>{devT.excerpt}</ReactMarkdown>
          </div>
          <div className="w-full h-0.5 bg-white/15 mb-10 sm:mb-12" />
          <div
            className="text-white/75 text-base sm:text-lg lg:text-xl text-justify leading-relaxed space-y-6"
            style={{ fontFamily: "Cormorant" }}
          >
            <ReactMarkdown>{devT.content}</ReactMarkdown>
            <div className="mt-16 pt-8 border-t border-white/15 ml-auto text-right w-fit">
              ...
              <p className="text-white/50" style={{ fontFamily: "Cormorant" }}>
                {post.authorType === "team" ? (author as TeamMember).role : ""}
              </p>
            </div>
          </div>
        </div>
