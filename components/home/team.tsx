                  ...
                  >
                    <div className="flex gap-4 items-start">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p
                          className="text-xs tracking-wider text-white/60 mb-1"
                          style={{ fontFamily: "Cinzel", fontWeight: 200 }}
                        >
                          {member.role}
                        </p>
                        <p
                          className="text-xs leading-relaxed tracking-wide text-white/70"
                          style={{ fontFamily: "Cinzel", fontWeight: 200 }}
                        >
                          {tMember.bioShort}
                        </p>
                      ...
                      >
                        <span
                          className={`text-lg leading-none transition-transform duration-300 ${isExpanded ? "rotate-45" : ""}`}
                        >
                          +
                        </span>
                      </button>
                    ...
                    <div
                      className={`overflow-hidden transition-all duration-500 ease-in-out ${isExpanded ? "max-h-96 mt-4" : "max-h-0"}`}
                    >
                      <div className="border-t border-white/20 pt-4">
                        <p
                          className="text-xs leading-relaxed tracking-wide text-white/80 mb-4"
                          style={{ fontFamily: "Cinzel", fontWeight: 200 }}
                        >
                          {tMember.bio}
                        </p>
                    ...
                    <Link href={`/collaborators/${c.id}`} key={c.id}>
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            borderColor:
                              projectTheme?.panelBorderHover ?? "rgba(255, 255, 255, 0.2)",
                          }}
                        >
                          <span
                            className="text-white/30 group-hover:text-white/70 text-sm transition-colors"
                            style={{ fontFamily: "Rye" }}
                          >
                            {c.name.charAt(0)}
                          </span>
                        ...
                        <p
                          className="text-base tracking-wide mb-1 text-white/80 group-hover:text-white transition-colors"
