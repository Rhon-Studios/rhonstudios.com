...
const followSocials = getSocials(["discord", "twitter", "youtube", "instagram", "tiktok", "linkedin"]);
                        ...
                        <div className="space-y-4 sm:space-y-8">
                            {isCompany ? (
                                <>
                                    <div className="border-2 border-white p-5 sm:p-8">
                                        <div className="flex items-center gap-4 sm:gap-6">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-xs tracking-wider uppercase mb-2 opacity-60" style={{ fontFamily: 'Cinzel', fontWeight: "bold" }}>
                                                    EMAIL
                                                </p>
                                                <a
                                                    href={SOCIALS.mail.url}
                                    ...
                                    <div className="border-2 border-white p-5 sm:p-8">
                                        <p className="text-xs tracking-wider uppercase mb-4 sm:mb-6 opacity-60" style={{ fontFamily: 'Cinzel', fontWeight: "bold" }}>
                                            {t.contact.openhours}
                                        </p>
                                ...
                                <>
                                    ...
                                    <div className="border-2 border-white p-5 sm:p-8 text-center">
                                        ...
                                        <p className="text-sm leading-relaxed mb-3 text-left" style={{ fontFamily: 'Cinzel' }}>
                ...
                {status === "sent" && (
                    ...
                    >
                        <div className="bg-black text-white border-2 border-white px-6 sm:px-10 py-4 sm:py-6 shadow-[0_0_30px_rgba(255,255,255,0.08)]">
                            <p className="text-xs tracking-[0.3em] uppercase text-center" style={{ fontFamily: "Cinzel", fontWeight: "bold" }}>
