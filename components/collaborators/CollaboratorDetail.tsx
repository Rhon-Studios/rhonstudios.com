...
export default function CollaboratorDetail() {
  ...
  const mediaImages = getCollaboratorMedia(collab.id);
        ...
        <div className="relative z-10 w-full container mx-auto px-8 lg:px-16 pb-16 pt-40">
          <div className="flex flex-col md:flex-row items-end gap-8 max-w-5xl">
            <motion.div
              ...
              className="relative shrink-0 w-32 h-32 border-2 overflow-hidden bg-white/[0.04] flex items-center justify-center"
                      ...
                      {item.url ? (
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <p
                            ...
                            style={{ fontFamily: "Cinzel" }}
                          >
                            {item.caption ?? item.title ?? "Próximamente"}
                          </p>
                        </div>
                      )}
