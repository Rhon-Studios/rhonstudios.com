...
const footerSocials = getSocials(["discord", "twitter", "youtube", "instagram", "tiktok", "linkedin"]);
...
export function Footer() {
    ...
    const isGamePage = !!gameId && !isCollabPage;

    const game = gameId && !isCollabPage ? getGameById(gameId) : null;
    ...
    const links: FooterLink[] = isGamePage
        ? gameLinks
        : isCollabPage
            ? [{ id: "team", label: t.menu.team, onClick: () => router.push("/#team") }]
            : isJoinPage
