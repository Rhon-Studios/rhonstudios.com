...
export const gamesData: GameData[] = [
  {
    ...
    thumbnail:
      "https://images.unsplash.com/photo-1763198216883-7473e2c7eabb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlcGljJTIwZmFudGFzeSUyMGFkdmVudHVyZSUyMG15c3RlcmlvdXN8ZW58MXx8fHwxNzcxOTQxNjI4fDA&ixlib=rb-4.1.0&q=80&w=1080",
    heroImage:
      "https://images.unsplash.com/photo-1763198216883-7473e2c7eabb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlcGljJTIwZmFudGFzeSUyMGFkdmVudHVyZSUyMG15c3RlcmlvdXN8ZW58MXx8fHwxNzcxOTQxNjI4fDA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    theme: {
      ...
      heroOverlay:
        "linear-gradient(to bottom, rgba(10,15,18,0.3) 0%, rgba(10,15,18,0.85) 70%, rgba(10,15,18,1) 100%)",
  ...
  },
  {
    ...
    heroImage: "/tinycare/Banner.png",
    thumbnail: "/tinycare/Banner.png",
    media: {
      screenshots: [],
      video: undefined,
      maskImage: undefined,
    ...
    theme: {
      ...
      heroOverlay: "from-[rgba(17,16,17,.30)] via-[rgba(17,16,17,.75)] to-[rgba(17,16,17,.90)]",
      heroFilter: "brightness(.65) saturate(.85)",
