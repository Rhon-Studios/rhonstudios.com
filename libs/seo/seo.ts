...
export const homeMetadata = generatePageMetadata({
  ...
  description:
    "Rhon Studios es un estudio indie creador de Afterlight, Tiny Care, The Observer y Tonkori. Desarrollamos mundos narrativos originales que se quedan contigo.",
  path: "/",
...
export const joinMetadata = generatePageMetadata({
  ...
  description:
    "Buscamos artistas, programadores, narrativistas y diseñadores de audio para colaborar en nuestros proyectos bajo un modelo de Revenue Share transparente.",
  path: "/join",
...
export const devblogsMetadata = generatePageMetadata({
  ...
  description:
    "Seguimiento en tiempo real del desarrollo de los proyectos de Rhon Studios: Afterlight, Tiny Care, The Observer y Tonkori. Proceso, decisiones y aprendizajes.",
  path: "/devblogs",
...
export const afterlightMetadata = generatePageMetadata({
  ...
  description:
    "Afterlight es un metroidvania indie de Rhon Studios donde la luz y la sombra definen quién eres. Una historia sin palabras, contada a través del diseño y la atmósfera.",
...
export const tinyCareMetadata = generatePageMetadata({
  ...
  description:
    "Tiny Care es un juego de mascotas virtuales para móvil de Rhon Studios donde las consecuencias son reales. Cuida a tu compañero o algo cambiará para siempre.",
  path: "/games/tinycare",
...
export const theObserverMetadata = generatePageMetadata({
  ...
  description:
    "The Observer es una novela visual otome de Rhon Studios donde el amor y el misterio coexisten. ¿Puedes confiar en alguien cuando todos guardan secretos?",
...
export const tonkoriMetadata = generatePageMetadata({
  ...
  description:
    "Tonkori es un RPG de Rhon Studios donde no hay respuestas correctas. Tus decisiones morales definen el mundo y a los personajes que te rodean.",
  path: "/games/tonkori",
