...
const GAMES: Record<GameId, object> = {
  afterlight: {
    ...
    name: "Afterlight",
    description:
      "Afterlight es un metroidvania atmosférico donde la coexistencia de la luz y la sombra define quién eres. Una historia sin palabras, contada a través del diseño y la atmósfera.",
  ...
  tinycare: {
    ...
    name: "Tiny Care",
    description:
      "Tiny Care es un juego de mascotas virtuales para móvil donde las consecuencias son reales. Si no cuidas a tu compañero, algo cambiará para siempre.",
  ...
  theobserver: {
    ...
    name: "The Observer",
    description:
      "The Observer es una novela visual otome de misterio donde el amor y la desconfianza coexisten. Descubre la verdad detrás de cada personaje.",
  ...
  tonkori: {
    ...
    name: "Tonkori",
    description:
      "Tonkori es un RPG donde las decisiones morales no tienen respuesta correcta. Cada elección redefine el mundo que te rodea.",
